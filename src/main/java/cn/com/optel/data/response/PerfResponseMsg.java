 ...
 * @see
 */
public class PerfResponseMsg extends Message {
	public static final short CMD_CODE = (short) 0x0C11;
	public static final int LENGTH_PER_PERF = 24;
	
	protected PerfResponseMsg(byte[] data, Channel channel) {
		super(data, channel);
	...
	public static PerfResponseMsg create(byte[] headData, byte[] msgData, Channel channel) {
		...
		return new PerfResponseMsg(data, channel);
	}
}
